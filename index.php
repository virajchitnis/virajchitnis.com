					...
					<table class="body_table">
						...
						<td class="body_table_data_center">
							<div class="body_table_content">
								...
								I love programming and have built multiple web applications.</p>
								<p class="body_table_content_text">I am from Mumbai, India and I currently live in Wynnewood, PA</p>
								<p class="body_table_content_text">I am majoring in Information Science & Technology at Temple University in Philadelphia, PA</p>
